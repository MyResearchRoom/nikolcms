...
class ProductController {
  ...
  static async addProduct(req, res, next) {
    try {
      const { title, subTitle, description, isPatented } = req.body;
      ...
      const isPatentedValue = Boolean(Number(isPatented)) || false;
      // const isPatentedValue = isPatented === "1" || isPatented === 1 ? 1 : 0;
      ...
      const product = await Product.create({
        ...
        isPatented: isPatentedValue,  // Stores patented value in form of 0 and 1
        userId: req.user.id,
      });
